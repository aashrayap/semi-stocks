...
- [ ] Wire `data/companies/` into `synthesis.py` — forward claims, thesis signals, earnings financials as new report inputs
- [ ] Complete COHR as second full-pipeline example (only full agreement zone across all 3 sources)
...
- [ ] Company deep dives for remaining watchlist (NVDA, MU, INTC, TSM, LITE)
